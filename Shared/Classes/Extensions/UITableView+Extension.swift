...
public extension UITableView {
    ...
    // MARK: Add footer loading view for pagination
    func addFooterLoadingView() {
        let loadingView = UIView(frame: CGRect(x: 0, y: 0, width: UIScreen.main.bounds.width, height: 60))
        let loading = UIActivityIndicatorView(frame: loadingView.frame)
...
public extension UITableView {
    func scrollToIndex(rowOfTableView: Int) {
        DispatchQueue.main.async {
            let indexPath = IndexPath(row: rowOfTableView, section: 0)
